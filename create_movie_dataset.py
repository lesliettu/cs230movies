...
def load_dataset(path_csv):
    ...
    with (open(path_csv, encoding="windows-1252") if use_python3 else open(path_csv)) as f:
        ...
        for example in examples[:SMALL_SET]:
...
if __name__ == "__main__":
    ...
    save_dataset(train_dataset, 'data/movie/train')
    save_dataset(dev_dataset, 'data/movie/dev')
    save_dataset(test_dataset, 'data/movie/test')
