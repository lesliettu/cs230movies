...
def input_fn(mode, sentences, labels, params):
    ...
    # ATTEMPT TO PAD SENTENCES ONLY AND FIRST
    # sentence_padded_shapes = ((tf.TensorShape([None]),  # sentence of unknown size
    #                   tf.TensorShape([])))
    # sentence_padding_values = ((params.id_pad_word,   # sentence padded on the right with id_pad_word
    #                    0))

    # sentences = (sentences
    #     .padded_batch(params.batch_size, padded_shapes=sentence_padded_shapes, padding_values=sentence_padding_values)
    # )
    ...
    # TODO: handle label padding differently
